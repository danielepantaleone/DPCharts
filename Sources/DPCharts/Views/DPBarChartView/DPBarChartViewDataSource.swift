...
public class DPBarChartViewIBDataSource: DPBarChartViewDataSource {
    ...
    public func numberOfDatasets(_ barChartView: DPBarChartView) -> Int {
        return 1
    }
    public func numberOfItems(_ barChartView: DPBarChartView) -> Int {
        return 8
    }
    public func barChartView(_ barChartView: DPBarChartView, valueForDatasetAtIndex datasetIndex: Int, forItemAtIndex index: Int) -> CGFloat {
