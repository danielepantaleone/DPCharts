...
enum ViewType: String, CaseIterable {
    ...
    case heatmapTextXAxisInverted = "Heatmap (X-axis inverted + text)"
    case heatmapTextYAxisInverted = "Heatmap (Y-axis inverted + text)"
    case heatmapTextXandYAxisInverted = "Heatmap (X/Y-axis inverted + text)"
